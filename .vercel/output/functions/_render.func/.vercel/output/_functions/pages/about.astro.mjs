...
import 'kleur/colors';
import { $ as $$MainLayout } from '../chunks/MainLayout_BocMpzex.mjs';
...
const about = new Proxy({"src":"/_astro/about.C1FZ3Rbp.jpg","width":6000,"height":4000,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/images/about.jpg";
							}
...
const team1 = new Proxy({"src":"/_astro/team1.CHXq7Isr.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/images/team1.png";
							}
...
const team2 = new Proxy({"src":"/_astro/team2.Ccx9qtIf.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/images/team2.png";
							}
...
const team3 = new Proxy({"src":"/_astro/team3.B0njnFun.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/images/team3.png";
							}
...
Our Team
</h2> <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8"> <div class="bg-white shadow-lg rounded-lg overflow-hidden"> ${renderComponent($$result2, "Image", $$Image, { "src": team1, "quality": "mid", "format": "avif", "alt": "Team Member 1", "class": "w-full h-auto" })} <div class="p-6"> <h3 class="text-xl font-semibold text-gray-900 mb-2">John Doe</h3> <p class="text-gray-70">Founder & Editor-in-Chief</p> </div> </div> <div class="bg-white shadow-lg rounded-lg overflow-hidden"> ${renderComponent($$result2, "Image", $$Image, { "src": team2, "quality": "mid", "format": "avif", "alt": "Team Member 2", "class": "w-full h-auto" })} <div class="p-6"> <h3 class="text-xl font-semibold text-gray-900 mb-2">Paul Newman</h3> <p class="text-gray-70">Lead Writer</p> </div> </div> <div class="bg-white shadow-lg rounded-lg overflow-hidden"> ${renderComponent($$result2, "Image", $$Image, { "src": team3, "quality": "mid", "format": "avif", "alt": "Team Member 3", "class": "w-full h-auto" })} <div class="p-6"> <h3 class="text-xl font-semibold text-gray-900 mb-2">Johanna Johnson</h3> <p class="text-gray-70">Tech Analyst</p> </div> </div> </div> </div> ` })}`;
}, "/home/zan/Code/astro-mbk-vercel/src/pages/about.astro", void 0);

const $$file = "/home/zan/Code/astro-mbk-vercel/src/pages/about.astro";
const $$url = "/about";
