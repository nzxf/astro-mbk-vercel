const id = "cutting-edge-tablets.md";
						const collection = "blog";
						const slug = "unleash-creativity-with-these-cutting-edge-tablets";
						...
						const data = {title:"Unleash Creativity With These Cutting-Edge Tablets",pubDate:new Date(1705190400000),author:"Ralph Johnson",image:
						new Proxy({"src":"/_astro/unleash-creativity-with-these-cutting-edge-tablets.CILSbp5L.png","width":1920,"height":1080,"format":"png","fsPath":"/home/zan/Code/astro-mbk-vercel/src/assets/unleash-creativity-with-these-cutting-edge-tablets.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/assets/unleash-creativity-with-these-cutting-edge-tablets.png";
							}
					...
					,tags:["tablets","gadgets"]};
						const _internal = {
							type: 'content',
							filePath: "/home/zan/Code/astro-mbk-vercel/src/content/blog/cutting-edge-tablets.md",
							rawData: undefined,
						};
