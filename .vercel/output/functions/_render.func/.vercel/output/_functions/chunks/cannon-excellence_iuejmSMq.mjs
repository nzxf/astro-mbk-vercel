const id = "cannon-excellence.md";
						const collection = "blog";
						const slug = "capturing-lifes-moments-with-canon-excellence";
						...
						const data = {title:"Capturing Life's Moments with Canon Excellence",pubDate:new Date(1705276800000),author:"David Mitchell",image:
						new Proxy({"src":"/_astro/capturing-lifes-moments-with-canon-excellence.CxT-4ig0.png","width":1920,"height":1080,"format":"png","fsPath":"/home/zan/Code/astro-mbk-vercel/src/assets/capturing-lifes-moments-with-canon-excellence.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/assets/capturing-lifes-moments-with-canon-excellence.png";
							}
					...
					,tags:["photography","canon","tech"]};
						const _internal = {
							type: 'content',
							filePath: "/home/zan/Code/astro-mbk-vercel/src/content/blog/cannon-excellence.md",
							rawData: undefined,
						};
