const id = "guardian-of-the-digital-realm.md";
						const collection = "blog";
						const slug = "guardian-of-the-digital-realm-web-security";
						...
						const data = {title:"Guardian of the Digital Realm: Web Security",pubDate:new Date(1705622400000),author:"John Doe",image:
						new Proxy({"src":"/_astro/guardian-of-the-digital-realm-web-security.aMmIPsro.png","width":1920,"height":1080,"format":"png","fsPath":"/home/zan/Code/astro-mbk-vercel/src/assets/guardian-of-the-digital-realm-web-security.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/assets/guardian-of-the-digital-realm-web-security.png";
							}
					...
					,tags:["code","security","tech"]};
						const _internal = {
							type: 'content',
							filePath: "/home/zan/Code/astro-mbk-vercel/src/content/blog/guardian-of-the-digital-realm.md",
							rawData: undefined,
						};
