const id = "world-of-drones.md";
						const collection = "blog";
						const slug = "soaring-to-new-heights-the-world-of-drones";
						...
						const data = {title:"Soaring to New Heights: The World of Drones",pubDate:new Date(1705363200000),author:"Sarah Davis",image:
						new Proxy({"src":"/_astro/soaring-to-new-heights-the-world-of-drones.BySF4Sar.png","width":1920,"height":1080,"format":"png","fsPath":"/home/zan/Code/astro-mbk-vercel/src/assets/soaring-to-new-heights-the-world-of-drones.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/assets/soaring-to-new-heights-the-world-of-drones.png";
							}
					...
					,tags:["drones","tech","gadgets"]};
						const _internal = {
							type: 'content',
							filePath: "/home/zan/Code/astro-mbk-vercel/src/content/blog/world-of-drones.md",
							rawData: undefined,
						};
