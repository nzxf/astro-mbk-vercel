const id = "immerse-in-the-virtual-world.md";
						const collection = "blog";
						const slug = "immerse-in-the-virtual-world-vr-development";
						...
						const data = {title:"Immerse in the Virtual World: VR Development",pubDate:new Date(1705536000000),author:"Michael Johnson",image:
						new Proxy({"src":"/_astro/immerse-in-the-virtual-world-vr-development.DgTZzg2O.png","width":1920,"height":1080,"format":"png","fsPath":"/home/zan/Code/astro-mbk-vercel/src/assets/immerse-in-the-virtual-world-vr-development.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/zan/Code/astro-mbk-vercel/src/assets/immerse-in-the-virtual-world-vr-development.png";
							}
					...
					,tags:["vr","gadgets","tech"]};
						const _internal = {
							type: 'content',
							filePath: "/home/zan/Code/astro-mbk-vercel/src/content/blog/immerse-in-the-virtual-world.md",
							rawData: undefined,
						};
